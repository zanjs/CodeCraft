...
(function () {
	...
	function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
		...
		function makeSpritedButtonRow() {
			...
			var makeButton = function (id, title, icon, textOp, group, buttonStyle, label) {
				var button = document.createElement("button");
                if(buttonStyle == null)
                buttonStyle = 'deafult';
				button.className = "btn btn-" + buttonStyle + " btn-sm";
			...
			if (helpOptions) {
                ...
                var helpButton = makeButton("wmd-preview-button", helpOptions.preview.title, "fa fa-eye", null, group5, 'primary', '预览');
                helpButton.onclick = helpOptions.preview.handler;
                var helpButton = makeButton("wmd-help-button", helpOptions.help.title, "fa fa-question-circle", null, group5, 'primary', '帮助');
                helpButton.onclick = helpOptions.help.handler;
//				group5 = makeGroup(5);
//				group5.className = group5.className + " pull-right";
...
//                previewButton.onclick = helpOptions.preview.handler;
//
//                setupButton(helpButton, true);
//                group5.appendChild(previewButton);
